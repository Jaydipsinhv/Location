...
var requiredString = joi.string().min(2).max(50).default("JD").required();
var string = joi.string().min(2).default("JDDDDD").max(50);
...
var requiredNumber = joi.number().default(50).required();
var requiredNumberStartFrom0 = joi.number().min(0).max(999999999).required();
var number = joi.number().min(0).max(999999999).default(0);
